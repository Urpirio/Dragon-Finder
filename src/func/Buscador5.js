...
import Buscador6 from "./Buscador6";
...
const Buscador5 = async (ValueInput) => {
    let Yes_Pass;
    // console.log('Se final')

    fetch('https://dragonball-api.com/api/characters?page=5&limit=10').then(

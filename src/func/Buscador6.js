...
const Buscador6 = async () => {
    ...
    fetch('https://dragonball-api.com/api/characters?page=6&limit=10').then(
        ...
        (Data) => {
            ...
            if(Existe == undefined){
                document.querySelector('.Resultado').innerHTML= '';
                        ...
                        if(1 == ArrayValueInput.length){
                        ...
                        }else if(11 == ArrayValueInput.length){
                            for(let z = 0; z < Data.items.length; z++){
                                ...
                                Filtro9 = Filtro8 && ArrayValueInput[8] == ArrayNameValueInput[8];
                                Filtro10 = Filtro9 && ArrayValueInput[9] == ArrayNameValueInput[9];
                                Filtro11 = Filtro10 && ArrayValueInput[10] == ArrayNameValueInput[10];
                         ...
                         }else if(12 == ArrayValueInput.length){
                            for(let z = 0; z < Data.items.length; z++){
                            ...
                            Filtro10 = Filtro9 && ArrayValueInput[9] == ArrayNameValueInput[9];
                            Filtro11 = Filtro10 && ArrayValueInput[10] == ArrayNameValueInput[10];
                            Filtro12 = Filtro11 && ArrayValueInput[11] == ArrayNameValueInput[11];
                        ...
                        }else if(13 == ArrayValueInput.length){
                            for(let z = 0; z < Data.items.length; z++){
                                ...
                                Filtro11 = Filtro10 && ArrayValueInput[10] == ArrayNameValueInput[10];
                                Filtro12 = Filtro11 && ArrayValueInput[11] == ArrayNameValueInput[11];
                                Filtro13 = Filtro12 && ArrayValueInput[12] == ArrayNameValueInput[12];
                            ...
                            }else if(14 == ArrayValueInput.length){
                                for(let z = 0; z < Data.items.length; z++){
                                    ...
                                    Filtro12 = Filtro11 && ArrayValueInput[11] == ArrayNameValueInput[11];
                                    Filtro13 = Filtro12 && ArrayValueInput[12] == ArrayNameValueInput[12];
                                    Filtro14 = Filtro13 && ArrayValueInput[13] == ArrayNameValueInput[13];
                            ...
                            }else if(15 == ArrayValueInput.length){
                                for(let z = 0; z < Data.items.length; z++){
                                    ...
                                    Filtro13 = Filtro12 && ArrayValueInput[12] == ArrayNameValueInput[12];
                                    Filtro14 = Filtro13 && ArrayValueInput[13] == ArrayNameValueInput[13];
                                    Filtro15 = Filtro14 && ArrayValueInput[14] == ArrayNameValueInput[14];
